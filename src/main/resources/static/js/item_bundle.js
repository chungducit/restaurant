...
var _TableList = __webpack_require__(61);
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      var seach_bar = _react2.default.createElement(_SearchBar2.default, { filterText: this.state.filterText,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { className: "col-5 section" },
          _react2.default.createElement(_Navbar2.default, { className: "navbar-light bg-light justify-content-between", title_nav: "Restaurant", content: seach_bar }),
          _react2.default.createElement(_TableList2.default, { filterText: this.state.filterText })
        ),
        _react2.default.createElement(
          "div",
          { className: "col-7 section" },
          _react2.default.createElement(
            "div",
            { className: "foods-container row no-gutters" },
            _react2.default.createElement(
              "div",
              { className: "foods-list col-6" },
              _react2.default.createElement(
                "div",
                { className: "row no-gutters" },
                _react2.default.createElement(
            ...
            _react2.default.createElement(
              "div",
              { className: "foods-selected col-6" },
              _react2.default.createElement(
                "div",
                { className: "row no-gutters" },
                _react2.default.createElement(
          ...
          _react2.default.createElement(
            "div",
            { className: "pay-container row no-gutters" },
            _react2.default.createElement(
              "div",
              { className: "row no-gutters" },
              _react2.default.createElement(
...
var Navbar = function (_React$Component) {
    ...
    _createClass(Navbar, [{
        key: 'render',
        value: function render() {
            var _className = 'navbar ' + this.props.className;
            var left_nav = this.props.left_nav || _react2.default.createElement(
                'a',
                { className: 'navbar-brand' },
                this.props.title_nav
            );
            return _react2.default.createElement(
                'nav',
...
var TableList = function (_React$Component) {
  ...
  function TableList(props) {
    ...
    _this.handleSelectTable = _this.handleSelectTable.bind(_this);
    return _this;
  }
  ...
  _createClass(TableList, [{
    ...
    value: function componentDidMount() {
      ...
      fetch('/api/v1/gettables').then(function (response) {
        ...
        _this2.setState({ tableInfo: json });
      });
    }
  }, {
    key: "handleSelectTable",
    value: function handleSelectTable(table) {
    ...
    value: function render() {
      ...
      var ft = this.props.filterText.toLocaleLowerCase();
      var rows = [];

      this.state.tableInfo.forEach(function (_table) {
        if (_table.name.toLocaleLowerCase().indexOf(ft) === -1) return;
        rows.push(_react2.default.createElement(_Table2.default, { key: _table.id, table: _table, SelectTable: _this3.handleSelectTable }));
      });

      return _react2.default.createElement(
        "div",
        { className: "tables row no-gutters" },
        rows
      );
    }
  }]);
...
var Table = function (_React$Component) {
  ...
  function Table(props) {
    ...
    //   };
    _this.handleClickOnTable = _this.handleClickOnTable.bind(_this);
    return _this;
  }

  _createClass(Table, [{
    key: "handleClickOnTable",
    value: function handleClickOnTable() {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { className: "col-3 _table", onClick: this.handleClickOnTable },
        _react2.default.createElement(
          "div",
